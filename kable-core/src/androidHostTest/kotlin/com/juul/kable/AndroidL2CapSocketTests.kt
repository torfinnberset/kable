...
// Stand-in for BluetoothSocket's InputStream: read blocks until the test feeds data, end of stream
// or a failure, like the real socket.
...
class AndroidL2CapSocketTests {
    ...
    fun socket_doesNotReadAheadOfCollector() = runTest(timeout = 5.seconds) {
        ...
        // Nothing is collecting, so the socket holds one chunk and does not read the next.
